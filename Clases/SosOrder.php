...
class SosOrder
{
	...
	function addSosOrder($sosData) {
        ...
        $sosDestination3Data = $sosData->sosFormDestination3Data->sosFormDestination3;
	   ...
	   if($respCode == 0) {
		...
		if($respCode == 0) {
			...
			$this->result = $this->util->db->Execute("INSERT INTO cc_sos_orden_tbl VALUES (0, '" . $sosPatientData->authNumber . "',
                                                                                              ...
                                                                                              '" . $sosDestination3Data->destination3 . "',
																							  STR_TO_DATE('".$sosDestination3Data->outputDate3->month."/".$sosDestination3Data->outputDate3->day."/".$sosDestination3Data->outputDate3->year."','%m/%d/%Y'),
																						 	  '" . $sosDestination3Data->time3 . "',
																						 	  '" . $sosDestination3Data->cost3 . "',
	   ...
	   if($respCode == 0) {
		...
		if($respCode == 0) {
			$this->result = $this->util->db->Execute("update cc_sos_orden_tbl set cc_id_autoriza_fld = '" . $sosPatientData->authNumber . "',
                                                                                    ...
                                                                                    cc_destino3_fld = '" . $sosDestination3Data->destination3 . "',
																				  	cc_fecha_d3_fld = STR_TO_DATE('".$sosDestination3Data->outputDate3->month."/".$sosDestination3Data->outputDate3->day."/".$sosDestination3Data->outputDate3->year."','%m/%d/%Y'),
																				  	cc_hora_d3_fld = '" . $sosDestination3Data->time3 . "',
																				  	cc_servicio3_fld = '" . $sosDestination3Data->cost3 . "',
	...
	function getSosOrderReport($numeroSosOrder) {
		$this->result = $this->util->db->Execute("select  
                                                    ...
                                                    ,(select cc_telefono_fld from cc_paciente_tbl pc where pc.cc_tipo_doc_fld = sos.cc_tipo_doc_fld  AND pc.cc_nume_doc_fld = sos.cc_nume_doc_fld) AS phone
                                                    ...
                                                    ,sos.cc_destino3_fld AS destination3
                                                    ,concat(DATE_FORMAT(sos.cc_fecha_d3_fld, '%Y-%m-%d'), ' ', sos.cc_hora_d3_fld) AS outputDate3
                                                    ,sos.cc_servicio3_fld AS cost3
	...
	function getSosOrder($numeroSosOrder) {
		$this->result = $this->util->db->Execute("select 	cc_id_autoriza_fld AS authNumber,
                                                            ...
                                                            cc_destino3_fld AS destination3,
                                                            DATE_FORMAT(cc_fecha_d3_fld, '%m/%d/%Y') AS outputDate3,
															cc_hora_d3_fld AS time3,
															cc_servicio3_fld AS cost3,
