...
$jFormSection1->addJFormComponentArray(array(
	new JFormComponentDropDown('maintenanceType', 'Tipo de documento:  ', $util->fillDropDownVew('cc_mantenimiento_fld', $result['maintenanceType']), array('disabled' => true, 'validationOptions' => array('required'))),
