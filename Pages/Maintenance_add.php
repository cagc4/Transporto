...
$jFormSection1->addJFormComponentArray(array(
	new JFormComponentDropDown('maintenanceType', 'Tipo de documento:  ', $util->fillDropDown('cc_mantenimiento_fld'), array('disabled' => false, 'validationOptions' => array('required'))),
