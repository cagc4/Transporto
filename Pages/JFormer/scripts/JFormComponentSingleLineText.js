    ...
    initialize: function() {
        ...
        this.validationFunctions = {
            ...
            'date': function(options) {
                var errorMessageArray = ['Debe ser fecha  mm/dd/yyyy format.'];
            ...
            'dateTime': function(options) {
                var errorMessageArray = ['Debe ser fecha  mm/dd/yyyy hh:mm:ss tt format. ss y tt son opcional.'];
            ...
            'decimal': function(options) {
                ...
                var errorMessageArray = ['Debe ser un numero sin comas. Decimal es opcional.'];
            ...
            'integer': function(options) {
                var errorMessageArray = ['Debe ser un número entero'];
                return options.value == '' || options.value.match(/^-?\d+$/) ? 'success' : errorMessageArray;
            },
            'integerNegative': function(options) {
                var errorMessageArray = ['Debe ser un número entero negativo'];
