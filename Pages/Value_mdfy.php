...
$userForm = new JFormer('valueForm', array('title' => '<div align="center"><h2>Modificacion de Valores</h2></div>', 'submitButtonText' => 'Modificar', 'requiredText' => '*', 'pageNavigator' => true));
...
$jFormSection1->addJFormComponentArray(array(
	...
	new JFormComponentSingleLineText('description', 'Descripcion:  ', array('initialValue' => $result['description'], 'disabled' => false, 'validationOptions' => array('required'))),
	...
	new JFormComponentDropDown('state', 'Estado:  ', $util->fillDropDownVew('cc_state_fld', $result['state'], true), array('disabled' => false, 'validationOptions' => array('required'))),
));
...
function onSubmit($formValues) {
	$value = new Value();
	$respCode = $value->modifyValue($formValues);
	if($respCode != 0) {
